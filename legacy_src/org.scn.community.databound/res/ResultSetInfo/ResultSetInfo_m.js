...
ResultSetInfo = {
	...
	createFlowPanel: function (label, value) {
		...
		var oLabel = new sap.m.Label({width: "60%", height: "22px"});
		oLabel.setText(label + ": ");
		oLabel.setDesign(sap.m.LabelDesign.Bold);
		
		var oText = new sap.m.Label({width: "40%", height: "22px", textAlign: sap.ui.core.TextAlign.Right});
		oText.setText(value);
		oText.setDesign(sap.m.LabelDesign.Normal);
